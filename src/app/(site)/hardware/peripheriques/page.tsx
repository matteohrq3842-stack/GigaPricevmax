...
export default function PeripheriquesPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0a0a0f]" />}>
      <PeripheriquesContent />
    </Suspense>
  );
}

function PeripheriquesContent() {
  ...
  function extractBrandFromTitle(title: string): string {
    ...
    const commonBrands = ['Logitech', 'Razer', 'Corsair', 'ASUS', 'MSI', 'Gigabyte', 'AMD', 'Intel', 'Nvidia', 'Samsung', 'HyperX', 'SteelSeries', 'Sony', 'Microsoft', 'Nintendo', 'HP', 'Dell', 'Lenovo', 'Acer', 'BenQ', 'LG', 'AOC'];
  ...
  return (
    <AmazonLoader isLoading={loading}>
      <AmazonAffiliateCatalog
        title="Périphériques"
        subtitle="Claviers, souris, casques… Le setup ultime commence ici."
        breadcrumb="Accueil › Hardware › Périphériques"
        products={products}
        searchPlaceholder="Rechercher un périphérique..."
