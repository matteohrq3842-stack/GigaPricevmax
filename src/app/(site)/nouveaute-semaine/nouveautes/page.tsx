...
export default function NouveautesSemainePage() {
    ...
    <main className="min-h-screen bg-[#0B0C15] text-white pt-28 pb-24">
      <div className="max-w-[1600px] mx-auto px-6">
        <header className="mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">Nouveautés de la semaine</h1>
          <p className="text-gray-400">Découvrez les dernières sorties et annonces.</p>
        </header>
            ...
            <div className="bg-[#14121e] border border-white/5 rounded-2xl p-6 shadow-xl">
              ...
              <nav className="space-y-4">
                <Link
                  ...
                  className="group block p-4 rounded-xl bg-white/5 border border-[#8B5CF6]/50 shadow-[0_0_15px_rgba(139,92,246,0.1)] transition-all duration-300 no-underline"
                >
                ...
                <Link
                  ...
                  className="group block p-4 rounded-xl bg-white/5 hover:bg-[#3B82F6]/20 border border-transparent hover:border-[#3B82F6]/50 transition-all duration-300 no-underline"
                >
                  <div className="flex items-center justify-between mb-2">
          ...
          <section className="w-full lg:w-3/4 space-y-12">
            ...
            {!loading && feedItems.length === 0 && (
              <div className="text-center py-20 text-gray-500">
                Aucune nouveauté récente à afficher.
              </div>
            )}
          </section>
        </div>
